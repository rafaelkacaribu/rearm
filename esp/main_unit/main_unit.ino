...
const int HOMING_SPEED = 25; 
const unsigned long HOMING_TIMEOUT = 15000; // 15 seconds

// Direction used during homing.
const SH_Direction HOMING_DIR_A1 = SH_Direction_Reverse;
const SH_Direction HOMING_DIR_A2 = SH_Direction_Reverse;
...
void setup() {
  ...
  touchA1.init(&evshield, SH_BAS1);
  touchA2.init(&evshield, SH_BAS2);
  touchB1.init(&evshield, SH_BBS1);
  touchB2.init(&evshield, SH_BBS2);
...
void homeAllMotors() {
  ...
  while (!(homedA1 && homedA2 && homedB1 && homedB2)) {
